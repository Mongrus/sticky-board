...
import { apiLogin } from '@/services/laravelApi'
...
const canSubmit = computed(() => email.value.trim() && password.value.length > 0 && !busy.value)
...
<template>
  <div class="auth-screen">
    <div class="auth-screen__card">
      <h1 class="auth-screen__title">Вход</h1>
      <p class="auth-screen__hint">Войдите, чтобы синхронизировать доску между устройствами.</p>
